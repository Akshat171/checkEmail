...
//         data.candidates[0]?.content[0]?.parts[0]?.text.trim() || "unknown";
            ...
            contents: [
              {
                parts: [
                  {
                    text: `You will be provided with an email snippet, and your task is to classify its category as spam, promotion, important, or marketing.\n\nEmail content:\n${email.snippet}`,
                  },
                ],
              },
            ],
