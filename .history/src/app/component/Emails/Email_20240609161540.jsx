    ...
    <div className="container mx-auto p-4">
      ...
      {selectedEmail && (
        <div className="fixed inset-0 overflow-hidden z-50">
          ...
          <div className="fixed right-0 top-0 h-full w-1/3 bg-white shadow z-50 transition-transform duration-300 transform translate-x-0">
            <div className="p-4">
              <button
                onClick={closeDrawer}
              ...
              <p className="text-gray-700">
                <span className="text-gray-600">Full Email:</span>{" "}
                {selectedEmail.smippet}
              </p>
...
const EmailDrawer = ({ email, onClose }) => {
  return (
    <div className="fixed right-0 top-0 h-full w-1/3 bg-white shadow z-10 transition-transform duration-300 transform translate-x-full">
      <div className="p-4">
        <button
          onClick={onClose}
          className="absolute top-4 right-4 text-gray-600 hover:text-gray-800"
        ...
        <p className="text-gray-700">
          <span className="text-gray-600">Full Email:</span> {email.fullEmail}
        </p>
        <p className="text-sm mt-2 font-bold">
          <span className="text-gray-600">Classification:</span>{" "}
          {email.classification}
